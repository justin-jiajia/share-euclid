# euclid
[demo]( https://hijiajia.top/euclid/ )
 ...
 - **Perpendicular**: Create a line perpendicular to a selected line through a selected point
 - **Angle bisector**: Create the bisector through a selected angle vertex
 - **Compass**: Create a circle with selected center and copied distance between two selected points
 - **Midpoint**: Create the midpoint of two selected points
 - **Vertical line**: Create the perpendicular bisector of the segment between two selected points
 - **Parallel**: Create a line parallel to a selected line through a selected point
